...
const projects = [
  ...
  {
    title: "Pokemon Skribble",
    description:
      "What if Skribbl.io, but Pokémon? Pokribble is a real-time multiplayer drawing and guessing game where one player draws a Pokémon and everyone else races to name it — built with WebSockets, React, and Fastify, with a fuzzy matching algorithm that tells you when you're close.",
    tags: [
      "React",
      "TypeScript",
      "Fastify",
